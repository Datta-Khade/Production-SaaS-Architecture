    ...
    <div className="p-6 h-full flex items-center justify-center">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl border border-gray-100 p-12 text-center animate-in fade-in zoom-in duration-500">
        ...
        <p className="text-gray-500 mb-8">
          The page for <code className="bg-gray-50 px-2 py-0.5 rounded font-mono text-blue-600">{location.pathname}</code> not yet available.Please develop it and bind it with the menu.
        </p>
