  ...
  return (
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      <DropdownMenuTrigger asChild>
        <Button variant="outline" className="w-full justify-between h-10 px-3 font-normal bg-white">
      ...
      <DropdownMenuContent
        className="w-[300px] p-0 bg-white shadow-xl border border-gray-200"
        align="start"
      >
        ...
        <div className="max-h-[300px] overflow-y-auto p-2 scrollbar-thin scrollbar-thumb-gray-200">
          <div className="grid grid-cols-6 gap-1">
            ...
            {filteredIcons.length === 0 && (
              <div className="col-span-6 p-4 text-center text-xs text-gray-400">No icons found</div>
            )}
          </div>
        </div>
      </DropdownMenuContent>
